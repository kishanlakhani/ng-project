...
export const PRODUCTLIST:IProductData[] = [
    ...
    {id:7,title:"Aarvee Denims & Exports Limited",price:38,stock:21},
    {id:8,title:"Accel Frontline Limited",price:54,stock:33},
    {id:9,title:"Adani Power Limited",price:20,stock:11},
    {id:10,title:"Adhunik Industries Limited",price:56,stock:50}
];